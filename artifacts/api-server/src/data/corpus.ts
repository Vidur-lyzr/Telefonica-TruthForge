...
export const GRAPH_NODES: GraphNode[] = [
  ...
  },
  {
    ...
    confidentiality: "private", validity: "approved",
...
export const KPI_ITEMS: KpiItem[] = [
  ...
  { id: "kpi-5g", name: "5G standalone coverage", axisId: "ax-networks", status: "off_target", clearance: "private", areas: ["Comunicación"] },
  { id: "kpi-b2b", name: "B2B & Tech revenue", axisId: "ax-b2b", status: "off_target", clearance: "confidential", areas: ["Comunicación", "Gabinete"] },
  { id: "kpi-brand", name: "Brand consistency score", axisId: "ax-sustainability", status: "tracked", clearance: "private", areas: ["Marca", "Comunicación"] },
];
...
export const PLANNING_EVENTS: PlanningEvent[] = [
  ...
  { id: "plan-brand-review", title: "Brand consistency review", thisWeek: true, conflict: false, clearance: "private", areas: ["Marca"] },
  ...
  { id: "plan-townhall", title: "Employee town hall follow-up", thisWeek: true, conflict: true, clearance: "private", areas: ["Comunicación"] },
  { id: "plan-atlas-checkpoint", title: "Project Atlas board checkpoint", thisWeek: false, conflict: false, clearance: "off_the_record", areas: ["Gabinete"] },
];
...
export const GENERATE_DRAFTS: GenerateDraft[] = [
  ...
  { id: "gen-brand-memo", title: "Brand refresh internal memo", status: "in_progress", clearance: "private", areas: ["Marca", "Comunicación"] },
  { id: "gen-5g-briefing", title: "5G coverage briefing", status: "review", clearance: "private", areas: ["Comunicación"] },
